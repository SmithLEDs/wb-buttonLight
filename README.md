...
На этом этапе у вас уже должен быть загружен модуль в контроллер. Смотри инструкцию на [главной странице](https://github.com/SmithLEDs/SmithLEDs?tab=readme-ov-file#установка-модулей-в-контроллер).
